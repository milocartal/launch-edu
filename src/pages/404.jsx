    ...
    return (
        <>
            ...
            <main className="flex flex-col min-h-screen w-full items-center justify-center bg-[#1A808C] ">
                ...
                <p className="text-[36px] font-Inter text-white -mt-10">Aïe, il semblerait que vous soyez perdu.e :(</p>
                <p className="text-base font-Inter text-white mb-10 mt-16">Quelques thématiques qui pourraient vous intéresser</p>
