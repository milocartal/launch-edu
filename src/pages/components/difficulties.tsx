    ...
    return(
        <div className="flex flex-row items-end">
            <svg width="7" height="11">
                <rect width="7" height="11" className="fill-[#0E6073] dark:fill-[#2EA3A5]" />
            </svg>
            {props.level !== 1 ?
            <svg width="7" height="21" className="mx-1">
                <rect width="7" height="21" className="fill-[#0E6073] dark:fill-[#2EA3A5]" />
            </svg > :
            <svg width="7" height="21" className="mx-1">
                <rect width="7" height="21" className="fill-[#989898] dark:fill-[#0E6073]" />
            </svg >}
            {props.level === 3 ?
            <svg width="7" height="30">
                <rect width="7" height="30" className="fill-[#0E6073] dark:fill-[#2EA3A5]" />
            </svg > :
            <svg width="7" height="30">
                <rect width="7" height="30" className="fill-[#989898] dark:fill-[#0E6073]" />
            </svg >}
        </div >
    )
}
