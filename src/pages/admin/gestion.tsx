...
const Gestionnaire: NextPage = () => {
    ...
    return (
        <>
            ...
            <main className="flex flex-col min-h-screen h-screen bg-white pl-24 pt-20 pb-10 pr-10 w-full">
                <Title title={"Gestion Technique"} link={"/admin"} />
                <div className='flex w-full justify-between h-[40%] items-center'>
                    <section className="flex flex-col max-h-[70%] w-[40%]">
                    ...
                    <section className="flex flex-col max-h-[70%] w-[40%]">
                        ...
                        <fieldset className="flex flex-col justify-between h-full w-full shadow-xl shadow-black/30 rounded-b-lg">
                            ...
                            <div className="flex items-center justify-center h-[5rem] w-full bg-[#2ea3a5] text-white hover:cursor-pointer transition hover:bg-[#0e6073] rounded-b-lg" onClick={(e) => setTab("type")}>
