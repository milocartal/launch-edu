                    ...
                    <form onSubmit={handleCrea} className='flex w-full justify-between h-full'>
                        <fieldset className='w-5/12 flex flex-col justify-between items-center'>
                            <fieldset className='w-full flex flex-col items-center w-full gap-5'>
                                ...
                                <QuillNoSSRWrapper placeholder='Description' className='h-64 w-full mb-2' onChange={setDesc} />
                        ...
                        <fieldset className='w-5/12 max-w-5/12 flex flex-col justify-between items-center'>
                            {type === "video" &&
                                ...
                                <QuillNoSSRWrapper placeholder='Transcript de la vidéo' className='w-full max-h-64 h-64 mb-16' onChange={setScript} />}

                            {type === "texte" &&

                                <QuillNoSSRWrapper placeholder='Texte du cours' className='w-full max-h-64 h-64 mb-16' onChange={setScript} />}
