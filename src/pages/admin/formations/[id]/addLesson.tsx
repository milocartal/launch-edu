...
const Formations: NextPage<InferGetServerSidePropsType<typeof getServerSideProps>> = ({ formation }) => {
    ...
    return (
        <>
            ...
            <main className="flex min-h-screen bg-white dark:bg-[#082F38] pl-24 pt-20 pb-10 pr-10 w-full justify-between">
                    ...
                    <form onSubmit={handleCrea} className='flex w-full justify-between h-full'>
                        ...
                        <fieldset className='w-5/12 max-w-5/12 flex flex-col justify-between items-center'>
                            {type === "video" &&
                                ...
                                <QuillNoSSRWrapper placeholder='Transcript de la vidéo' className='w-full max-h-64 h-64 pb-10 dark:bg-[#041F25] dark:text-white' onChange={setScript} />}

                            {type === "texte" &&

                                <QuillNoSSRWrapper placeholder='Texte du cours' className='w-full max-h-64 h-64 pb-10 dark:bg-[#041F25] dark:text-white' onChange={setScript} />}
                        ...
                        <form className="relative flex flex-col gap-5 item-center justify-start bg-white dark:bg-[#082F38] rounded-xl p-16 w-8/12 text-[#041f25]">
                            ...
                            <div className='flex w-full gap-5 justify-center mb-10'>
                                <fieldset className='flex flex-col gap-3 w-[45%] max-w-[45%]'>
                                    <legend className="text-xl font-bold tracking-tight text-[#0E6073] dark:text-[#1A808C] mb-2">Exercice</legend>
                                    ...
                                    <QuillNoSSRWrapper
                                        className='dark:bg-[#041F25] pb-16 h-56'
                                ...
                                <fieldset className='flex flex-col gap-3 w-[45%] max-w-[45%]'>
                                    <legend className="text-xl font-bold tracking-tight text-[#0E6073] dark:text-[#1A808C] mb-2">Solution</legend>
