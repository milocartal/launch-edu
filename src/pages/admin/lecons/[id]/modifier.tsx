...
const Formations: NextPage<InferGetServerSidePropsType<typeof getServerSideProps>> = ({ lecon }) => {
    ...
    return (
        <>
            ...
            <main className="flex min-h-screen h-screen bg-white dark:bg-[#041F25] pl-24 pt-20 pb-10 pr-10 w-full justify-between">

                <div className="flex flex-col gap-5 w-full h-full">
                    <div className="flex flex-row items-center justify-start px-10">
                        <Link href={`/admin/lecons/${lecon.id}`}><FaArrowLeft className="h-6 w-6 text-[#0E6073] mr-5" /></Link>
