        ...
        <>
            ...
            <main className="flex min-h-screen flex-col items-center bg-white">
                ...
                <div className="container flex flex-col items-start justify-start gap-12 px-4 py-20">
                    <div className="flex flex-row items-center justify-between px-10 w-10/12">
                ...
                <div className="w-2/12 fixed right-0 flex bg-[#0E6073] flex-col items-center h-full pt-10">
                    <div className="w-full bg-[#1A808C] h-44 flex flex-col items-start pt-10">
