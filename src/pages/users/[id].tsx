...
const user: NextPage<InferGetServerSidePropsType<typeof getServerSideProps>> = ({ user }) => {
    ...
    return (
        <>
            ...
            <main className="flex flex-row min-h-screen bg-white justify-between px-10 dark:bg-[#041F25]">
                ...
                <div className="flex max-h-screen flex-col items-start justify-center w-5/12 mr-20 dark:bg-[#0E6073]">
                    <h1 className="text-xl font-bold tracking-tight text-[#0E6073] dark:text-white mb-8">Mettre à jour mon profil</h1>
