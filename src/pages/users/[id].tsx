...
const user: NextPage<InferGetServerSidePropsType<typeof getServerSideProps>> = ({ user }) => {
    ...
    return (
        <>
            ...
            <main className="flex flex-row min-h-screen bg-white justify-between px-10 dark:bg-[#082F38]">
                <div className="flex max-h-screen flex-col items-center justify-center w-5/12 ml-20">
                    <div className="flex flex-col items-center justify-center h-full">
                        <div className="bg-[#e6e6e6] dark:bg-[#041F25] flex flex-row justify-center items-center mb-4 w-96 h-40 px-6 w-8/12 rounded-xl">
                            ...
                            <div>
                                {sessionData && sessionData.user?.image &&<h3 className="text-xl font-bold tracking-tight text-[#0E6073] dark:text-[#2EA3A5]">{sessionData.user.name}</h3>}
                ...
                <div className="flex max-h-screen flex-col items-start justify-center w-5/12 mr-20">
                    <h1 className="text-xl font-bold tracking-tight text-[#0E6073] dark:text-[#2EA3A5] mb-8">Mettre à jour mon profil</h1>
                    <form onSubmit={updateProfile} className="flex flex-col items-center" method="POST">
                        <div className="bg-white dark:bg-[#041F25] flex flex-row justify-start items-center mb-4 w-96 h-14 px-6 shadow-[inset_4px_4px_12px_4px_rgba(0,0,0,0.25)] w-8/12 rounded-lg">
                        ...
                        <div className="bg-white dark:bg-[#041F25] flex flex-row justify-start items-center 2 w-96 h-14 px-6 shadow-[inset_4px_4px_12px_4px_rgba(0,0,0,0.25)] w-8/12 rounded-lg">
