                ...
                <main className="flex min-h-screen bg-white justify-between dark:bg-[#041F25]">
                    ...
                    <div className="fixed w-full pr-40 border-b-4 border-[#63aeab] bg-white top-0 right-0 left-28 h-[4rem]" /><div className="flex item-center justify-between gap-12 fixed w-full pr-40 top-0 right-0 left-28 h-[4rem] text-[#63aeab]">
                        <div className="flex item-center justify-evenly">
                            ...
                            <Link href={`/formation`} className="h-[4rem]"><button className="px-10 py-3 font-semibold border-[#0E6073] transition hover:border-b-4 hover:text-[#0E6073]">Explorer</button></Link>

                            <button className="px-10 py-3 font-semibold border-[#0E6073] border-b-4 text-[#0E6073]" autoFocus><Link href={`/admin/main`}>Gérez les cours</Link></button>
                        </div>
